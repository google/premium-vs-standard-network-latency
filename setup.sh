...
$(chmod ugo+x $CWD/createBackend.sh)
$(chmod ugo+x $CWD/crontab.sh)
...
. $CWD/setupBackend.sh backendRegion.csv true

# Write crontab.txt file
. $CWD/crontab.sh backend.csv true

# Add firewall rule
. $CWD/firewall.sh true
